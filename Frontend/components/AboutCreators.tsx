  ...
  return (
    <div className="max-w-4xl mx-auto pb-12 animate-fade-in-up">
      ...
      <div className="text-center mb-12">
        <h2 className="text-5xl font-black text-slate-900 dark:text-white mb-4 tracking-tight drop-shadow-sm">Meet the Creators</h2>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {creators.map((creator, idx) => (
          ...
          >
            <div className={`absolute inset-0 bg-gradient-to-br ${creator.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}></div>
            <div className={`h-36 bg-gradient-to-r ${creator.color} relative overflow-hidden shrink-0`}>
                <div className="absolute inset-0 bg-black/10 dark:bg-black/20 pattern-dots"></div>
                <div className="absolute w-full h-full bg-white/20 blur-2xl -top-10 -right-10 rounded-full group-hover:scale-150 transition-transform duration-700"></div>
            ...
            <div className="pt-14 p-8 text-center relative z-10 flex flex-col flex-grow">
                <h3 className="text-2xl font-black text-slate-800 dark:text-white mb-2">{creator.name}</h3>
                <div className="mb-5"><span className={`inline-block px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border border-slate-200/50 dark:border-slate-700/50 shadow-inner`}>
                    {creator.role}
                </span></div>
                ...
                <div className="flex justify-center gap-4 mt-auto">
                    <button className="w-10 h-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-emerald-500 hover:text-slate-900 dark:text-white dark:hover:bg-emerald-500 transition-all shadow-sm hover:shadow-emerald-500/20 hover:-translate-y-1">
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </button>
                    <button className="w-10 h-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-blue-500 hover:text-slate-900 dark:text-white dark:hover:bg-blue-500 transition-all shadow-sm hover:shadow-blue-500/20 hover:-translate-y-1">
