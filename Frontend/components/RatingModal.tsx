        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button 
                type="submit"
                disabled={rating === 0}
                className="flex-1 py-3 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:bg-slate-800 disabled:bg-slate-300 text-slate-900 dark:text-white font-black rounded-2xl transition-colors shadow-lg shadow-slate-200 uppercase text-xs tracking-wider"
              >
                Submit
              </button>
            </div>
