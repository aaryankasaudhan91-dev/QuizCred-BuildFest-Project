      ...
      return (
          <div className="max-w-2xl mx-auto pt-10 text-center animate-fade-in-up">
              <div className="bg-white rounded-[2.5rem] p-12 shadow-xl border border-emerald-100">
                  ...
                  <button onClick={onBack} className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white px-8 py-4 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-slate-100 dark:bg-slate-800 transition-all shadow-lg hover:-translate-y-0.5">Back to Dashboard</button>
              </div>
          </div>
      );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto pb-12 animate-fade-in-up">
      ...
      <div className="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-slate-100 relative">
        <div className="bg-white dark:bg-slate-900 p-10 text-slate-900 dark:text-white relative overflow-hidden">
             ...
             <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div className="flex-1">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 font-medium max-w-sm leading-relaxed mb-6">We're here to help with any questions, technical issues, or feedback you might have.</p>
                    
                    <div className="flex flex-col md:flex-row gap-3">
                        <a href="tel:+918591095318" className="inline-flex items-center gap-3 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-slate-200 dark:border-white/10 px-5 py-3 rounded-2xl transition-all group">
                            <div className="w-10 h-10 bg-emerald-500 rounded-xl flex items-center justify-center text-slate-900 dark:text-white shadow-lg group-hover:scale-110 transition-transform shrink-0">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-bold text-slate-900 dark:text-white tracking-wide">+91 85910 95318</p>
                            </div>
                        </a>

                        <button onClick={() => setShowAiChat(true)} className="inline-flex items-center gap-3 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-slate-200 dark:border-white/10 px-5 py-3 rounded-2xl transition-all group text-left">
                            <div className="w-10 h-10 bg-blue-500 rounded-xl flex items-center justify-center text-slate-900 dark:text-white shadow-lg group-hover:scale-110 transition-transform shrink-0">
                                 <span className="text-xl">🤖</span>
                            </div>
                            <div>
                                <p className="text-[10px] font-black uppercase tracking-widest text-blue-300">Instant Help</p>
                                <p className="text-lg font-bold text-slate-900 dark:text-white tracking-wide">Chat with AI</p>
                            </div>
                        </button>
                    </div>
                </div>
                <div className="hidden md:flex w-16 h-16 bg-white/10 backdrop-blur-md rounded-2xl items-center justify-center text-emerald-400 border border-slate-200 dark:border-white/10 shrink-0">
        ...
        <form onSubmit={handleSubmit} className="p-8 md:p-10 space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    <label className="text-xs font-black text-slate-500 dark:text-slate-400 uppercase ml-1 tracking-widest">Name</label>
                ...
                <div className="space-y-2">
                    <label className="text-xs font-black text-slate-500 dark:text-slate-400 uppercase ml-1 tracking-widest">Email</label>
            ...
            <div className="space-y-2">
                <label className="text-xs font-black text-slate-500 dark:text-slate-400 uppercase ml-1 tracking-widest">Subject</label>
            ...
            <div className="space-y-2">
                <label className="text-xs font-black text-slate-500 dark:text-slate-400 uppercase ml-1 tracking-widest">Message</label>
            ...
            <div className="pt-4">
                <button type="submit" disabled={isSubmitting} className="w-full bg-white dark:bg-slate-900 hover:bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-black py-4 rounded-2xl uppercase text-xs tracking-widest shadow-xl shadow-slate-200 transform hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:transform-none">
                    {isSubmitting ? (
                        <>
